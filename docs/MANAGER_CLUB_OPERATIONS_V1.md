...
> **Navigasjonsstatus 10.08.2026:** Påstanden nedenfor om Kontor → Innboks er historisk v1. Canonical normalflyt er Kontor → Kalender, der konkrete klubbmailer er hendelser i arbeidsdagen. Se `MANAGER_CALENDAR_V1.md` og `MANAGER_CLUB_COMMUNICATION_V3.md`.
