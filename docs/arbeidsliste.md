...
**Avdeling 1 (8 gjenstår, 1 av dem ferdig undersøkt):** Eik Tønsberg · Vidar · Kvik Halden · Sandviken · Lysekloster · Sotra · Træff · ~~Bjarg~~

**Bjarg er lest ut og gir ikke en pool (24.08.2026).** Kilden er gjennomgått i sin helhet — alle 66 artiklene på `bjargsinhistorie.no`, pluss Wikipedia, klubbsiden og forbundet — og bærer **fire A-lagsnavn, ett av dem med posisjon**: Frank Berentsen (midtstopper), Rolf Birger Pedersen (spillende trener 1973), Kjell Jensen og Stig Arve Vangsnes. En klubb trenger femten dokumenterte tilknytninger for å være overtakbar, så fire profiler gjør ikke Bjarg spillbar, og importen ville satt `playerPoolStatus: ready` på en pool som ikke kan stille et lag. Klubben står derfor `pending`, og de fire er skrevet ned med sitat og årstall i `docs/P2_BJARG_SOURCE_PASS.md` så ingen leser de 66 artiklene på nytt.
