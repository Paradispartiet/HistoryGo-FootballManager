...
const checks = [
  ...
  ["ingen ny lagring skrives", !scouting.includes("localStorage.setItem")],
  ["ingen ny rekrutteringsmotor", !scouting.includes("Math.random") && !scouting.includes("transferFee") && !scouting.includes("wage")],
