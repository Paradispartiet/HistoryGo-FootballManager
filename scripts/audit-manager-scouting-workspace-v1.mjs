...
const checks = [
  ...
  ["rekruttering skriver kun til eksisterende teamMerits-state", scouting.includes('merits: "hgfm.teamMerits.v1"') && scouting.includes("localStorage.setItem") && scouting.includes("recruitPlayerToMerits")],
  ...
  ["dokumentasjonen skiller kandidat fra tropp", docs.includes("History Go-tilgang = kandidat") && docs.includes("Hent til troppen = troppsmedlem")],
