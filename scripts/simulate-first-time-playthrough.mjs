...
check("spillbar first-time state gir Start prøveperiode", primary(base) === "Start femkampers prøveperiode");
...
check("lest innboks men manglende trening gir Velg trening", primary({ ...base, miniSeasonActive: true, unreadThreads: 0, firstTime: { ...base.firstTime, started: true, hasRoles: true, hasReadInbox: true }, lineup: { ...base.lineup, emptyCount: 0 }, matchdayReady: true }) === "Velg trening for Ajax-kampen");
