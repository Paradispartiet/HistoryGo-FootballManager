...
const KJENT_UDOKUMENTERT = {
  ...
  pors_stadion: 0.99, // Pors: Oskar source-depth senket målt tomandel
  ...
  stemmemyren: 0.94,            // Sandviken: Marthinussen source-depth senket målt tomandel
  ...
  straume_idrettspark: 0.92,    // Sotra: Skålevik source-depth senket målt tomandel
