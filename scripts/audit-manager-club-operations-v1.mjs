...
check("Speiding løftes ut av Kontor uten å flytte klubbdriften", files.scouting.includes('historySection.dataset.tabParent = "historygo"') && files.shell.includes('createSubtab(subnav, "board", "Klubbdrift")'));
